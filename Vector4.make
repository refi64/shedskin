...
LFLAGS=-lgc -lpcre $(LDFLAGS) -shared -Xlinker -export-dynamic -lpthread -ldl  -lutil -lm -lpython2.6 -L/usr/lib/python2.6/config -Wl,-rpath,. -L. -lShedskin

all:	Vector4.so

CPPFILES=Vector4.cpp /home/srepmub/shedskin/shedskin/lib/re.cpp
