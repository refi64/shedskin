...
LFLAGS=-lgc -lpcre $(LDFLAGS) -shared -Xlinker -export-dynamic -lpthread -ldl  -lutil -lm -lpython2.6 -L/usr/lib/python2.6/config -L. -lVector4 -lShedskin

all:	test2.so

CPPFILES=test2.cpp /home/srepmub/shedskin/shedskin/lib/re.cpp
